...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("it.tecnomedia.cropview.b4i_main");
        //anywheresoftware.b4a.pc.RapidSub.moduleToObject.put("it.tecnomedia.cropview.b4i_main", "it.tecnomedia.cropview.b4i_main");
	}
...
public static RemoteObject _imageviewcrop1 = RemoteObject.declareNull("b4i_imageviewcrop");
public static RemoteObject _imageview1 = RemoteObject.declareNull("B4IImageViewWrapper");
  public Object[] GetGlobals() {
		return new Object[] {"App",b4i_main._app,"ImageView1",b4i_main._imageview1,"ImageViewCrop1",b4i_main._imageviewcrop1,"NavControl",b4i_main._navcontrol,"Page1",b4i_main._page1};
}
}